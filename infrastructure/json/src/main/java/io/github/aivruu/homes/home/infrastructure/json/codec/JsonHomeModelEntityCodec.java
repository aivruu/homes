...
public enum JsonHomeModelEntityCodec implements JsonSerializer<HomeModelEntity>, JsonDeserializer<HomeModelEntity> {
  ...
  @Override
  public HomeModelEntity deserialize(final JsonElement json, final Type type, final JsonDeserializationContext ctx) throws JsonParseException {
  ...
  @Override
  public JsonElement serialize(final HomeModelEntity homeModel, final Type type, final JsonSerializationContext ctx) {
    final JsonObject jsonObject = new JsonObject();
    jsonObject.addProperty("id", homeModel.id());
    jsonObject.addProperty("owner-id", homeModel.ownerId());
