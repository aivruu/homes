...
package io.github.aivruu.homes.minimessage.application;
...
public final class MiniMessageHelper {
  ...
  public static @NotNull Component parse(final @NotNull String[] text, final @NotNull TagResolver... resolvers) {
    final TextComponent.Builder componentBuilder = Component.text();
    for (final String message : text) {
      componentBuilder
        .append(MINI_MESSAGE.deserialize(message, resolvers))
        .appendNewline();
    }
